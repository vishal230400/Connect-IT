...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.ViewHolder> {
    ...
    public void userInfo(final ViewHolder viewHolder, String userid, final int position)
    {
